    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "faaefacd-1dbd-4d7e-8c53-2dda37592b42", "Admin", "ADMIN" },
                    { "2", "75551a02-f55c-43a5-a7d4-6070c93831c8", "Store Owner", "STORE OWNER" },
                    { "3", "3c621e23-5159-49aa-9e95-34e329eb32f0", "Customer", "CUSTOMER" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "BookId", "CustomerId", "Order_Date", "Payment", "Quantity" },
                values: new object[] { 2, 2, 2, new DateTime(2022, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, 20 });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "BookId", "CustomerId", "Order_Date", "Payment", "Quantity" },
                values: new object[] { 1, 1, 1, new DateTime(2021, 10, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 2 });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "BookId", "CustomerId", "Order_Date", "Payment", "Quantity" },
                values: new object[] { 3, 5, 1, new DateTime(2022, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 30 });
