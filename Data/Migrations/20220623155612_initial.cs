    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Store_Owner", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "5feaa5d6-ae5f-4c09-a331-ccfb59285476", "Admin", "ADMIN" },
                    { "2", "1cad4bf2-d954-40d3-91d5-93b2adc376bf", "Store Owner", "STORE OWNER" },
                    { "3", "543d32a1-a087-4505-8c0b-db77e06c6787", "Customer", "CUSTOMER" }
                });
