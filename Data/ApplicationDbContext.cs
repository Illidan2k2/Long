    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public void SeedOrder(ModelBuilder builder)
        {
            builder.Entity<Order>().HasData(
                new Order { Id = 1, CustomerId = 1, BookId = 1, Quantity = 2, Order_Date = DateTime.Parse("2021-10-12"), Payment = Payment.Cash},
                new Order { Id = 2, CustomerId = 2, BookId = 2, Quantity = 20, Order_Date = DateTime.Parse("2022-01-02"), Payment = Payment.Visa},
                new Order { Id = 3, CustomerId = 1, BookId = 5, Quantity = 30, Order_Date = DateTime.Parse("2022-03-05"), Payment = Payment.Mastercard}
                );
        }
    }
}
